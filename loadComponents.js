                                ...
                                ${plan.features.map(feature => `
                                    <li>
                                        <span class="plan-feature-icon">
                                            <img src="img/icon-park-solid--check-one.png" alt="">
                                        </span>
            ...
            fetch('pos.json')
                ...
                .then(data => {
                    const posHTML = data.pos.map(pos => `
                        <div class="pos">
                            <div class="pos-logo">
                                <img width="64" height="64" src="img/solar--shop-bold.png" alt="${pos.name}">
                            </div>
                            <div class="pos-info">
                                <span class="pos-name">${pos.name}</span>
                                <span class="pos-address">
                                    <span class="pos-address-icon">
                                        <img class="w-5 h-5 animate-bounce" src="img/mdi--address-marker.png" alt="${pos.name}">
                                    </span>
